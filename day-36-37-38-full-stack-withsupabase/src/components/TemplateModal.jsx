...
import { BookOpen, Code2, Calendar, Rocket, BrainCircuit, Cog, Megaphone, Network, Film, X } from 'lucide-react';
      ...
      <div className="relative w-[90vw] max-w-5xl max-h-[85vh] bg-[#161618] border border-white/10 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-white/5 bg-[#111113] shrink-0">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Start your next spatial workspace with a powerful preset.</p>
          </div>
          <button 
            onClick={onClose}
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center border ${tpl.bgClass} transition-colors duration-200 shrink-0`}>
