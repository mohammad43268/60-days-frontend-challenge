...
export const ExportModal = () => {
  ...
  const exportCSV = () => {
    ...
    const rows = cards.map(c => {
      ...
      const status = Array.isArray(c.content) ? (c.content.every(t => t.done) ? 'Done' : 'In Progress') : 'N/A';
    ...
    <div className="fixed inset-0 z-[9999] bg-gray-900/40 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50/50">
          ...
          <button onClick={closeExportModal} className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            {/* Obsidian */}
            <button onClick={exportObsidian} className="w-full flex items-center px-4 py-3 border border-gray-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition-colors group text-left">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500">.canvas - Open in Obsidian or JSON Canvas viewers</div>
              </div>
            </button>

            {/* CSV Spreadsheet */}
            <button onClick={exportCSV} className="w-full flex items-center px-4 py-3 border border-gray-200 rounded-xl hover:border-green-300 hover:bg-green-50 transition-colors group text-left">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500">.csv - Open in Excel, Google Sheets, or Numbers</div>
              </div>
            </button>

            {/* Markdown */}
            <button onClick={exportMarkdown} className="w-full flex items-center px-4 py-3 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-colors group text-left">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500">.md - Open in Notion, VS Code, or Obsidian</div>
              </div>
            </button>

            {/* Image Snapshot */}
            <button onClick={exportImage} className="w-full flex items-center px-4 py-3 border border-gray-200 rounded-xl hover:border-pink-300 hover:bg-pink-50 transition-colors group text-left">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500">.png - High-res transparent capture of the canvas</div>
              </div>
            </button>
