...
export const HeroSection = ({ onLoginClick }) => {
  ...
  return (
    <section
      ref={heroRef}
      className="parallax-section relative z-0 w-full min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-bg-base"
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none flex items-center justify-center opacity-30">
        <svg
          ...
          height="600"
          viewBox="0 0 800 600"
          className="opacity-60 scale-125 md:scale-100"
        >
          <g stroke="var(--accent-ink)" strokeWidth="1.5" fill="none">
            <path
              className="node-path"
              d="M 100 300 C 200 200, 300 400, 400 300 S 600 200, 700 300"
            />
            <path
              className="node-path"
              d="M 250 150 C 350 250, 450 150, 550 250 S 650 450, 400 450"
            />
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto flex flex-col items-center">
        ...
        <p className="hero-fade font-body text-lg md:text-xl text-text-muted mb-16 max-w-2xl mx-auto leading-relaxed">
          Strip away the noise. Zaforge provides a pure, unhindered space to architect your ideas,
          structure data, and map workflows with absolute clarity.
        </p>
