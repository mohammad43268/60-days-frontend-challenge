...
export const FlipDemoSection = () => {
  ...
  const mockData = [
    { id: 1, title: 'Project Alpha', status: 'Active', color: 'bg-orange-200', assignee: 'JD', priority: 'High', priorityColor: 'text-red-600 bg-red-100', dueDate: 'Nov 24' },
    { id: 2, title: 'Design System', status: 'Review', color: 'bg-blue-200', assignee: 'AM', priority: 'Medium', priorityColor: 'text-orange-600 bg-orange-100', dueDate: 'Nov 26' },
    { id: 3, title: 'Backend API', status: 'Planning', color: 'bg-green-200', assignee: 'SB', priority: 'High', priorityColor: 'text-red-600 bg-red-100', dueDate: 'Dec 02' },
    { id: 4, title: 'User Testing', status: 'Done', color: 'bg-purple-200', assignee: 'JD', priority: 'Low', priorityColor: 'text-blue-600 bg-blue-100', dueDate: 'Nov 18' },
    { id: 5, title: 'Marketing Assets', status: 'Active', color: 'bg-pink-200', assignee: 'KL', priority: 'Medium', priorityColor: 'text-orange-600 bg-orange-100', dueDate: 'Dec 05' },
    { id: 6, title: 'Security Audit', status: 'Planning', color: 'bg-yellow-200', assignee: 'SB', priority: 'High', priorityColor: 'text-red-600 bg-red-100', dueDate: 'Dec 15' },
  ];
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center" ref={containerRef}>
        ...
        <div className="text-center mb-16 relative z-10">
          ...
          <p className="font-body text-text-muted max-w-2xl mx-auto">
            Break out of restrictive linear documents. Map your architecture, link dependencies, and visually structure your workflow in a boundless 2D space.
          </p>
        </div>
          ...
          {mockData.map((item, index) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className={`w-10 h-10 rounded-xl flex-shrink-0 shadow-inner ${item.color}`}></div>
                <div className="font-display font-bold text-text-primary text-[1.1rem] leading-tight">{item.title}</div>
              </div>
              ...
              <div className="flex items-center justify-between mt-auto pt-4 border-t border-accent-ink/10">
                <div className="">
                  <span className={`px-2.5 py-1 rounded-lg text-xs font-bold ${item.priorityColor}`}>
                    {item.priority}
                  </span>
                </div>
